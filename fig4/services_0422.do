	...
	*local ytitle Employment Share
	...
	append using $project/data/services04
	...
	*/
	...
	replace sh_emp7 = sh_emp1+sh_emp2
	replace sh_emp8 = sh_emp5+sh_emp6	
	...
	twoway 	line sh_emp7 sh_emp3 sh_emp4 sh_emp8 year,  ///
			...
			title("`ind'", ///
			size(medium)) ylabel(0(.1).6, nogrid) legend( size(medium large) pos(6) ring(1) rows(1)  ///
