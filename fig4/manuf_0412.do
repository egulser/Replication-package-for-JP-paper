	...
	saveold $project/data/tmp/2004_sec2, replace
	...
	ren sh_emp_occ sh_emp	
	merge isco88 using $project/data/iscotask2004.dta		
	saveold $project/data/tmp/2008_sec2, replace	
	...
	ren sh_emp_occ sh_emp	
	merge isco88 using $project/data/iscotask2004.dta		
	saveold $project/data/tmp/2012_sec2, replace	
	
	use 			$project/data/tmp/2004_sec2 ,clear
	append using 	$project/data/tmp/2008_sec2
	append using 	$project/data/tmp/2012_sec2
	...
	saveold $project/data/manuf04, replace
	...
	twoway 	line sh_emp7 sh_emp3 sh_emp4 sh_emp8 year,  ///
		...
		imargin(1 1 1) ycommon xcommon legendfrom(taskServices.gph)  ysize(9) xsize(9.0) name(grc_graphs, replace) saving(grc_graphs, replace) pos(6) span
		*gr_edit legend.xoffset = 0
		*gr_edit legend.yoffset = 8
		
		graph export $project/fig/fonseca5_v3.pdf, replace
		
		graph combine grc_graphs.gph, ysize(2) xsize(3)
